...
execute store result score @s enm_van_crft_cnt run clear @s knowledge_book
...
execute store result entity @e[type=item,sort=nearest,limit=1] Item.Count byte 1 run scoreboard players get @s enm_van_crft_cnt
